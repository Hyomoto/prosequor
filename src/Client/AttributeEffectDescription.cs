...
public static class AttributeEffectDescription
{
    ...
    static readonly Dictionary<string, RuleDisplay> Displays = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["prosequor:inc-animal-seeking-range"] = new(false, AttributeEffectDisplayKind.Tiered),
        ["prosequor:inc-animal-response-rate-flee"] = new(false, AttributeEffectDisplayKind.Tiered),
        ["prosequor:inc-animal-response-rate-seek"] = new(false, AttributeEffectDisplayKind.Tiered),
        ["prosequor:inc-animal-response-rate"] = new(false, AttributeEffectDisplayKind.Tiered),
